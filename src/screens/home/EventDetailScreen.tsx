      ...
      <ScrollView
            ...
            <Card.Header>
              <YStack>
                ...
                <YStack
                  ...
                  padding={16}>
                  <Text fontWeight={700} fontSize={'$6'} color={'whitesmoke'}>
                    {event.title}
                  </Text>
        ...
        <YStack width={'100%'} padding={16} gap={12}>
          <YStack padding={16} gap={12} backgroundColor={'white'}>
            ...
            <Stack
              paddingBottom={40}
              maxHeight={shouldCollapse() && isCollapsed ? 300 : 'unset'}
              overflow="hidden"
              position="relative"
            ...
            {shouldCollapse() && (
              <Button
                position="absolute"
                iconAfter={isCollapsed ? <ChevronDown /> : <ChevronUp />}
                bottom={0}
                zIndex={1}
                size="$3"
                height={40}
          ...
          <YStack
            ...
            gap={12}
            backgroundColor={'#38383d'}>
            <Text fontSize={'$6'} fontWeight={'700'} color={'whitesmoke'}>
              Thông tin vé
            </Text>
            <Separator />
            <Accordion
                      ...
                      <>
                        <XStack
                          ...
                          <Square
                            ...
                            <ChevronRight size="$1" color={'whitesmoke'} />
                          </Square>
                          <Text
                            ellipsizeMode="tail"
                            fontWeight={800}
                        ...
                        <YStack key={ticketIndex + ticket.name}>
                          <XStack
                            ...
                            <YStack alignItems="flex-end">
                              ...
                              {ticket.stock > 0 ? (
                                <Text color={'darkorange'} fontSize={'$3'}>
                                  {ticket.stock} vé
                                </Text>
                              ) : (
            ...
            <YStack>
              <XStack alignItems="center" justifyContent="space-between">
                <Avatar circular size="$7">
                  <Avatar.Image src={getOrganizationLogo(event.organization)} />
                  <Avatar.Fallback
                ...
                <Button borderRadius={0} icon={<Plus />}>
                  Theo dõi
                </Button>
              </XStack>
